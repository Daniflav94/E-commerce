...
export class DestaquesComponent implements OnInit{
  ...
  destaques: Produto[] = [
    ...
    },
    {
      ...
      price: 764.90,
      picture_url: ["assets/img/pop-keys-gallery-daydream-1.webp", "assets/img/pop-keys-gallery-daydream-6.webp", "assets/img/pop-keys-gallery-daydream-2.webp"],
      category: "Teclados"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: 86.90,
      picture_url: ["assets/img/mouse1-1.png", "assets/img/mouse1-2.png"],
      category: "Mouses"
    },
    {
      id: 6,
      ...
      price: 499.90,
      picture_url: ["assets/img/mouse2-1.png", "assets/img/mouse2-2.png"],
      category: "Mouses"
    },
    {
      id: 7,
      ...
      price: 219.90,
      picture_url: ["assets/img/mouse3-1.png", "assets/img/mouse3-2.png", "assets/img/mouse3-3.png"],
      category: "Mouses"
    },
    {
      id: 17,
      ...
      price: 123.90,
      picture_url: ["assets/img/mouse7-1.png", "assets/img/mouse7-2.png"],
      category: "Mouses"
    },
    {
      id: 18,
      ...
      price: 247.90,
      picture_url: ["assets/img/teclado2-1.png", "assets/img/teclado2-2.png", "assets/img/teclado2-3.png"],
      category: "Teclados"
    },
    {
      id: 19,
      ...
      price: 699.90,
      picture_url: ["assets/img/headset3-1.png", "assets/img/headset3-2.png", "assets/img/headset3-3.png"],
      category: "Audio"
    },
    {
      id: 20,
      ...
      price: 169.90,
      picture_url: ["assets/img/caixa1-1.png", "assets/img/caixa1-2.png"],
      category: "Audio"
    },
    {
      id: 21,
      ...
      price: 764.90,
      picture_url: ["assets/img/teclado3-1.png", "assets/img/teclado3-2.png", "assets/img/teclado3-3.png", "assets/img/teclado3-4.png"],
      category: "Teclados"
    },
    {
      id: 22,
      ...
      description: "Crie seu próprio espaço com o Logitech Pebble M350 – um mouse moderno, slim, silencioso e portátil projetado para seu estilo de vida. Escolha este mouse slim e moderno que cabe facilmente no bolso e pode ser levado para o café, biblioteca ou onde você quiser. Com clique e rolagem silenciosos você pode manter o foco sem perturbar as pessoas ao seu redor. A bateria tem duração de até 18 meses para que você não precise se preocupar em perda de energia. Conecte o seu Pebble do jeito que você preferir - via Bluetooth ou via receptor USB. Com rastreamento óptico de alta precisão que funciona na maioria das superfícies. *A vida útil das pilhas pode variar de acordo com a sua utilização.",
      price: 123.90,
      picture_url: ["assets/img/mouse8-1.png", "assets/img/mouse8-2.png"],
      category: "Mouses"
    },
  ]
